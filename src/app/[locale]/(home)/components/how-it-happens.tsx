...
export const HowItHappens = () => {
  return (
    <section className="mx-4 flex flex-col gap-10 bg-white px-[60px] py-[100px] max-md:px-4 max-md:py-[60px]">
      <Title>
        From First “Let’s Talk” to “This Is Working” — Here&apos;s How It
        Happenss
      </Title>
      <Slider />
      <span className="flex items-start justify-between gap-2 max-md:flex-col">
        ...
        <Link href="/what-to-expect">
          <Button>
            What to Expect <ArrowRight color="black" />
          </Button>
        </Link>
      </span>
    </section>
...
const slides = [
  ...
  },
  {
    ...
    name: 'Your Strategy, Your Way',
    text: 'You’ll get a clear, personalized game plan — not a generic checklist. Timeline? Tools? Priorities? All mapped out and made for you.',
  },
  {
    imgUrl: '/images/home/how-it-happens/3.jpg',
    name: 'Sessions That Move You Forward',
    text: 'Weekly or biweekly 1:1s packed with insights, action steps, and accountability — think consulting meets coaching with momentum built in.',
  },
  {
