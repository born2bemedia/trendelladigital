    ...
    body: `
      <div class="wrapper">
        ...
        <div class="main">
          ...
          <p class="text">Thank you for placing your order with <strong style="font-weight: 700;">Signalor</strong> — we’re excited to support your next stage of growth.</p>
          ...
          <p class="text">If you have any questions or want to share something specific about your business before we get started, feel free to reply to this email or reach us directly at info@signalor.pro.</p>
          <p class="text">We’re truly looking forward to partnering with you.</p>
          <p class="text" style="font-size: 18px;">Warm regards,<br /><strong style="font-weight: 700;">The Signalor Team</strong></p>
        </div>
